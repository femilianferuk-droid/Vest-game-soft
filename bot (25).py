...
# Единственная модель, доступная пользователю.
...
# В SmartAPI оставлена только sonnet-4.6 (через официальный Anthropic SDK).
LLM_MODELS = {
...
async def init_db():
    ...
    async with db_pool.acquire() as conn:
        ...
        try:
            ...
            pass
        # Пользовательская настройка LLM-модели (сейчас доступна только sonnet-4.6).
        try:
            await conn.execute(
